		...
		<div class="card">
			...
			<div class="row">
				<a class="btn btn-primary"
					href="http://localhost:2024/WareHouseApp/ordermethod/reg" role="button">
				...
				<table
					...
					<c:forEach items="${list}" var="obj">
						<tr>
							...
							<td><c:out value="${obj.orderMode }"></c:out></td>
							<td><c:out value="${obj.orderCode }"></c:out></td>
							<td><c:out value="${obj.executionType }"></c:out></td>
							<%-- <td><c:out value="${obj.orderAccept }"></c:out> --%>
							<%-- <td><c:out value="${obj.description }"></c:out> --%>
